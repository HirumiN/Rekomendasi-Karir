...
def delete_semester_calendar(db: Session, user: models.User, semester: models.Semester):
    """
    Deletes the Google Calendar associated with the semester (if any).
    """
    if not semester.google_calendar_id:
        return
    delete_calendar(user, semester.google_calendar_id)
